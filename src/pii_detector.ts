...
export async function callPiiDetectionEndpoint(textToCheck: string, azurLanguageEndpoint: string, azureLanguageSubscriptionKey: string): Promise<ResponseDocumentRoot> {
  try {
